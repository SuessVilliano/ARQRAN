...
function Landing({session,theme,setTheme}){
 const goStudio=()=>location.assign(session?'/studio':'/login?next=/studio')
...
export default function ProductShell(){
 ...
 if(path==='/studio'||path.startsWith('/studio/'))return <StudioGate session={session} loading={loading}/>
